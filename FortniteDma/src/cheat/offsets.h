...
uintptr_t LocationUnderReticle = 0x2798;
uintptr_t WeaponData = 0x570;
uintptr_t CurrentWeapon = 0xa80;
uintptr_t WeaponProjectileSpeed = 0x1B48;
uintptr_t WeaponProjectileGravity = 0x1B4C;
